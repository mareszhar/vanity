...
export function vanityPlugin(options: VanityViteOptions = {}): PluginOption[] {
  ...
  const injectShimFor = async (filePath: string): Promise<string | undefined> => {
    ...
    const nextDeclarationsRegistration = [
      ...
      '/// <reference path="../../.vanity/auto-imports.d.ts" />',
      '',
    ].join('\n')
 ...
 * `node_modules/.vanity/auto-imports.d.ts`; Nuxt registers the same text at
 * `.nuxt/vanity-auto-imports.d.ts`. Plain Vite also writes a tiny generated
 * `@types/vanity-auto-imports` reference bridge so ordinary TypeScript
