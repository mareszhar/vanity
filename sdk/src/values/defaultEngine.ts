...
import type { VanityAuthoredColor, VanityAuthoredInterpolatedColor, VanityColor, VanityColorish, VanityInterpolatedColor } from '../tokens/types'
...
/** Exact CSS `light-dark()` overloads on a finalized engine or system. */
...
/** Constructors as seen from a canonical engine/system. */
