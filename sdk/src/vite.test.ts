/**
 * The build plane: `*.css.ts` modules are evaluated at build time and leave
...
`)
    ...
    expect(() => bundle.className({})).toThrow('[vanity] class is build-plane')
  })
...
describe('auto-imports', () => {
  ...
  it('generates exact ambient aliases with a stable self-describing banner', () => {
    expect(styleAutoImportDeclarations('/design/authoring.ts', ['ds', 'css'])).toBe(
      `/* generated by vanity — do not edit */
import type * as VanityStyleAutoImports from "/design/authoring.ts"

declare global {
  /** Auto-imported from /design/authoring.ts. */
  const ds: typeof VanityStyleAutoImports.ds
  /** Auto-imported from /design/authoring.ts. */
  const css: typeof VanityStyleAutoImports.css
}
...
`)
  ...
  it('regenerates exact globals when system exports are added and removed', async () => {
    ...
    try {
      ...
      expect(await retransform()).toContain('const brand: typeof VanityStyleAutoImports.brand')
